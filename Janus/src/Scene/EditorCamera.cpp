...
#define BIND_EVENT_FN(fn) std::bind(&EditorCamera::fn, this, std::placeholders::_1)
...
namespace Janus {
	...
	void EditorCamera::OnUpdate(Timestep ts)
	{
		...
		//{
			...
			if (Input::IsMouseButtonPressed(JN_MOUSE_BUTTON_MIDDLE))
				MousePan(delta);
			else if (Input::IsMouseButtonPressed(JN_MOUSE_BUTTON_LEFT))
				MouseRotate(delta);
